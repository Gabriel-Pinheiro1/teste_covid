  ...
  useEffect(() => {
    ...
    switch (true) {
      case fCardiaca >= 1 && fCardiaca < 60:
        message = 'Frequência Cardíaca abaixo da normalidade (BRADICARDÍACO)';
        color = 'red';
        break;

      case fCardiaca >= 60 && fCardiaca <= 100:
        message = 'Frequência Cardíaca dentro da normalidade (NORMOCARDÍACO)';
        color = 'green';
        break;

      case fCardiaca > 100:
        message = 'Frequência Cardíaca acima da normalidade (TAQUICARDÍACO)'
        color = 'red';
        break;
    ...
    <Container className="mt-4 ">
      <Form onSubmit={handleEnviar}>
        <div className="text-center">
          <h2 className='mt-5 text-primary-emphasis'>Formulário de triagem</h2>
          <hr />
        </div>
        ...
        <div className="text-center">
          <h2 className='mt-5 text-primary-emphasis'>Marque os sintomas que o paciete está sentido</h2>
          <hr />
        </div>
